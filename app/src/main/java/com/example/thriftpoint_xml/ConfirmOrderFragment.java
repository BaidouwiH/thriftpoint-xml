...
import com.example.thriftpoint_xml.recycler_view.ProductOnCheckoutAdapter;
...
public class ConfirmOrderFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        ProductOnCheckoutAdapter productOnCheckoutAdapter = new ProductOnCheckoutAdapter(
                viewModel.getProductsOnCart().getValue()
        );
        rvProducts = view.findViewById(R.id.rvProducts);
        rvProducts.setLayoutManager(new LinearLayoutManager(getContext()));
        rvProducts.setAdapter(productOnCheckoutAdapter);

        TextView subtotalPriceText = view.findViewById(R.id.subtotalPriceText);
        ...
        subtotalPriceText.setText("Rp " + totalPrice);
        totalPriceText.setText("Rp " + totalPrice);
