...
public class TermsConditionsFragment extends Fragment {
     ...
     * @return A new instance of fragment TermsConditionsFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static TermsConditionsFragment newInstance(String param1, String param2) {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        addProduct.setOnClickListener(v -> {
            getActivity().getSupportFragmentManager()
                    .beginTransaction()
                    .replace(R.id.flFragment, new AddProductFragment())
                    .addToBackStack("termsConditions")
                    .commit();
        });
    }
}